# QTYPES int8, int4, and none work with skittles on FP16
# QTYPES none on BF16
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_id", type=str, default="miike-ai/skittles-v2")
    parser.add_argument("--prompt", type=str, default="ghibli style, a fantasy landscape with castles")
    parser.add_argument("--torch_dtype", type=str, default="bf16", choices=list(TORCH_DTYPES.keys()))
    parser.add_argument("--qtype", type=str, default="int4", choices=list(QTYPES.keys()))
